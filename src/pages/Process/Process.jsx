          ...
          <div className={ styles.description }>
            <ul>
              ...
              <li>
                ...
                <ul>
                  <li>Sales will be trained to identify and to establish a correct procedure with the consumer</li>
                  <li>
                    F&amp;I will be trained to structure deals and obtain better adequate approvals for consumers with less obstacles to facilitate the sale
                    <ul>
                  ...
                  <li>Sales Managers/Front Desk will be advised on deal structuring, inventory selection and sub-prime consumer mindset</li>
                </ul>
              </li>
            </ul>
          </div>
